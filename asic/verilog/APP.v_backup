...
wire  B0, CLK, RE, RST_INIT, VTH_armpeak, VTH_armvalley, VTH_peak,
...
APP_chan APPchan1 ( .WE_ampl(WE_ampl), .WE_time(WE_TOTback),
     .timePeak1(timePeak1), .timePeak2(timePeak2),
     .timeValley1(timeValley1), .amplitudeValley1(amplitudeValley1),
     .amplitudePeak2(amplitudePeak2), .amplitudePeak1(amplitudePeak1),
     .eventEdge_back(eventEdge_back),
     .eventEdge_front(eventEdge_front),
     .sel_TOT_event(sel_TOT_event[3:1]), .TOT_INTEGRAL(TOT_INTEGRAL),
     .GND(GND), .VDD(VDD), .VDDH(VDDH), .B0(B0), .CLK(CLK), .RE(RE),
